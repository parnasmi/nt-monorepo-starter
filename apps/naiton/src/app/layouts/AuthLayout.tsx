    ...
    <main className="min-h-screen bg-[linear-gradient(90deg,#ffffff_0%,#ffffff_26%,#0f8f52_26%,#38b86a_100%)]">
      <div className="grid min-h-screen lg:grid-cols-[minmax(320px,420px)_1fr]">
        <section className="relative flex flex-col justify-between overflow-hidden bg-white px-8 py-10 sm:px-10 lg:px-12">
          <div>
            <div className="inline-flex items-center gap-3">
              <div className="flex h-14 w-14 items-center justify-center rounded-full border-2 border-primary/30 bg-primary/10 text-2xl font-bold text-primary">
                N
              </div>
              <div>
                <p className="text-4xl font-semibold tracking-tight text-primary">Naiton</p>
                <p className="text-sm font-medium tracking-[0.24em] text-primary/80 uppercase">
                  Business Suite
                </p>
              </div>
            </div>
        ...
        <section className="relative hidden overflow-hidden lg:block">
          ...
          <div className="absolute -left-[10%] top-[-12%] h-[70%] w-[55%] rounded-full border border-emerald-300/45" />
          <div className="absolute -left-[8%] top-[-8%] h-[82%] w-[63%] rounded-full border border-emerald-300/40" />
          <div className="absolute -left-[6%] top-[-4%] h-[94%] w-[71%] rounded-full border border-emerald-300/35" />
          <div className="absolute -bottom-[28%] right-[-4%] h-[92%] w-[46%] rounded-full border border-emerald-300/35" />
          <div className="absolute -bottom-[22%] right-[-2%] h-[80%] w-[40%] rounded-full border border-emerald-300/30" />
          <div className="absolute left-1/2 top-1/2 flex h-72 w-72 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-[72px] border border-white/12 bg-white/8 shadow-2xl backdrop-blur-sm">
