    ...
    <section className="space-y-4 p-3 sm:p-5">
      <div className="naiton-surface rounded-[26px] p-5">
        ...
        <p className="mt-2 max-w-2xl text-sm text-slate-500">
          Phase 8 establishes the module shell. Live stock movements and transfer flows plug into
          the shared API layer in later phases.
        </p>
      </div>
        ...
        <div className="naiton-grid-bg naiton-surface rounded-[24px] p-6">
          <div className="grid gap-4 md:grid-cols-3">
            {["Receiving", "Storage", "Dispatch"].map((zone) => (
              <div
                key={zone}
                className="rounded-[22px] border border-white/70 bg-white/85 p-5 shadow-sm"
              >
