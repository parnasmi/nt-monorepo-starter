...
export function RegisterPage() {
	return (
		<section className='naiton-panel w-full rounded-[28px] p-6 shadow-[0_24px_60px_rgba(15,23,42,0.12)]'>
			...
			<h1 className='mt-5 text-3xl font-semibold tracking-tight text-slate-800'>Company onboarding</h1>
			<p className='mt-2 text-sm leading-6 text-slate-500'>
				Registration screens are intentionally deferred while the PoC focuses on login, routing, and persistent shell
				behavior.
			</p>
