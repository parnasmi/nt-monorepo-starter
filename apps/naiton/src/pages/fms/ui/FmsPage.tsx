    ...
    <section className="h-full p-3 sm:p-5">
      <div className="naiton-surface grid h-[calc(100vh-112px)] gap-0 overflow-hidden rounded-[26px] xl:grid-cols-[290px_1fr]">
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="text-right">
                    <span
                      className={cn("mb-2 inline-flex h-2.5 w-2.5 rounded-full", vehicle.color)}
                    />
        ...
        <div className="relative overflow-hidden">
          <div className="absolute inset-0 naiton-map-bg" />
          <div className="absolute left-6 top-6 rounded-2xl border border-white/60 bg-white/92 px-4 py-3 shadow-lg">
