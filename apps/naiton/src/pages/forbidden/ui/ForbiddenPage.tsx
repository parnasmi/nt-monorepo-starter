  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-6">
      <section className="naiton-panel max-w-xl rounded-[32px] p-8 text-center">
        ...
        <h1 className="mt-5 text-4xl font-semibold tracking-tight text-slate-800">
          Access restricted
        </h1>
        <p className="mt-3 text-sm leading-6 text-slate-500">
          Your current subscription does not include this product yet. The route guard is active and
          the persistent shell is working as expected.
        </p>
