	...
	return (
		<section className='space-y-4 p-3 sm:p-5'>
			<div className='naiton-surface rounded-[26px] p-5'>
				...
				<p className='mt-2 max-w-2xl text-sm text-slate-500'>Manufacturing orders and production line status.</p>
			</div>
					...
					<div key={o.id} className='naiton-surface rounded-[20px] p-4'>
						...
						{o.completion > 0 && o.completion < 100 && (
							<div className='mt-3 h-2 overflow-hidden rounded-full bg-slate-100'>
								<div className='h-full rounded-full bg-sky-500' style={{ width: `${o.completion}%` }} />
							</div>
						)}
					</div>
				))}
