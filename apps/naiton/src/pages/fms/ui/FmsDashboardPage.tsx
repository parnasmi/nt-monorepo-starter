	...
	return (
		<section className='space-y-4 p-3 sm:p-5'>
			<div className='naiton-surface rounded-[26px] p-5'>
				...
				<h1 className='mt-2 text-3xl font-semibold tracking-tight text-slate-800'>Fleet dashboard</h1>
			...
			<div className='grid gap-4 xl:grid-cols-2'>
				<div className='naiton-surface rounded-[24px] p-6'>
					...
					<ul className='mt-4 space-y-3 text-sm text-slate-600'>
						...
						<li className='flex items-center gap-2'>
							<span className='h-2 w-2 rounded-full bg-emerald-500' /> ZK-112-L — Scheduled service completed
						</li>
					</ul>
				</div>
				<div className='naiton-surface rounded-[24px] p-6'>
