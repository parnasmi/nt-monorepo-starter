	...
	return (
		<section className='space-y-4 p-3 sm:p-5'>
			<div className='naiton-surface rounded-[26px] p-5'>
				<p className='text-sm font-semibold tracking-[0.22em] text-slate-500 uppercase'>Dashboard</p>
				<h1 className='mt-2 text-3xl font-semibold tracking-tight text-slate-800'>Revenue breakdown</h1>
				...
				<div className='mt-4 space-y-4'>
					{channels.map((ch) => (
						<div key={ch.name} className='flex items-center gap-4'>
							...
							<span className='w-16 text-right text-sm font-semibold text-slate-700'>{ch.revenue}</span>
							<span
